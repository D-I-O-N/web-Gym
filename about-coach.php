          ...
          <nav class="rd-navbar container rd-navbar-floated rd-navbar-dark" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-top-panel context-dark bg-danger">
                ...
                <div class="center">
                  <address class="contact-info text-left"><a href="#"><span class="icon mdi mdi-map-marker-radius novi-icon"></span><span class="text-middle">+7 949 894 25-67
г. Макеевка, улица Ленина, 24, офис 12, стр. 2</span></a></address>
                </div>
              ...
              <div class="rd-navbar-menu-wrap">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <!--Navbar Brand Mobile-->
                    <div class="rd-navbar-mobile-brand"><a href="index.php"><img width='80' height='80' src='images/logo.png' alt=''/></a></div>
                    <!-- RD Navbar Nav-->
                    <ul class="rd-navbar-nav">
                      <li><a href="index.php"><span>Главная</span></a></li>
                      <li class="active"><a href="about-coach.php"><span>О Коучах</span></a></li>
        ...
        <div class="context-dark">
          <!-- Modern Breadcrumbs-->
          <section>
            <div class="parallax-container breadcrumb-modern bg-gray-darkest" data-parallax-img="images/04-750.jpg">
              <div class="parallax-content"> 
                <div class="container section-top-98 section-bottom-34 section-lg-bottom-66 section-lg-98 section-xl-top-110 section-xl-bottom-41">
                  <h2 class="d-none d-lg-block offset-top-30"><span class="big">О Коучах</span></h2>
                  <ul class="list-inline list-inline-dashed">
                    <li class="list-inline-item"><a href="index.php">Главная</a></li>
                    <li class="list-inline-item">О Коучах
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row justify-content-sm-center">
            <div class="col-sm-10 col-md-5">
              ...
              if(isset($_POST['fio'])) {
                $selected_coach_fio = $_POST['fio'];



$sql = "SELECT * FROM about_coaches WHERE fio = :coach_fio";
    $stmt = $db->prepare($sql);
    $stmt->bindParam(':coach_fio', $selected_coach_fio, PDO::PARAM_STR);
    $stmt->execute();
    $selected_coach = $stmt->fetch(PDO::FETCH_ASSOC);
    

    if ($selected_coach) {
      $show_img = base64_encode($selected_coach['img']);
        echo "
        
        <div class='member-block-type-5 inset-lg-right-20'><img class='img-fluid mx-auto d-block' src='data:image/jpeg;base64, {$show_img}' width='437' height='437' alt=''/>
        <div class='member-block-body'><a class='btn btn-block btn-danger' href='contacts.php'>Записаться</a>
          ...
          <address class='contact-info offset-top-20 offset-md-top-34'>
            <ul class='list-unstyled p'>
              <li><span class='novi-icon icon icon-xxs text-middle text-dark mdi mdi-phone'></span><a class='p big text-middle d-inline-block offset-top-0' href='tel:+7 949 894 25-67'>+7 949 894 25-67</a></li>
    ...
    <div class='col-sm-10 col-md-7 text-md-left'>
      <div>
        ...
        <h1 class='text-darker'>" . htmlspecialchars($selected_coach['fio']) . "</h1>
        </div>
        <p class='text-muted offset-top-4'>" . htmlspecialchars($selected_coach['specialization']) . "</p>
        <hr class='divider bg-red hr-md-left-0'>
        <p class='offset-top-50 text-left'>" . htmlspecialchars($selected_coach['longt_desc']) . "</p>
        <div class='offset-top-30 text-center'>
          <p>
            <q class='font-italic h3 text-regular'>" . htmlspecialchars($selected_coach['quote']) . "</q>
          </p>
        </div>
        <div class='offset-top-30'>
          <p class='text-left'>" . htmlspecialchars($selected_coach['about career']) . "</p>
        </div>
        <div class='offset-top-50'>";
    } else {
        echo "<h1>Выберите коуча</h1>";
    }
              ...
              ?>
                ...
                <div class="progress-linear" data-to="70">
                  <div class="progress-linear-header clearfix">
                    <div><span class="progress-linear-title p text-ubold pull-left text-uppercase">Фитнес</span></div>
                ...
                <div class="offset-top-50">
                  ...
                  <div class="progress-linear" data-to="54">
                    <div class="progress-linear-header clearfix">
                      <div><span class="progress-linear-title p text-ubold pull-left text-uppercase">Кроссфит</span></div>
                ...
                <div class="offset-top-50">
                  ...
                  <div class="progress-linear" data-to="87">
                    <div class="progress-linear-header clearfix">
                      <div><span class="progress-linear-title p text-ubold pull-left text-uppercase">Йога</span></div>
                ...
                <div class="offset-top-50">
                  ...
                  <div class="progress-linear" data-to="65">
                    <div class="progress-linear-header clearfix">
                      <div><span class="progress-linear-title p text-ubold pull-left text-uppercase">Бодибилдинг</span></div>
      ...
      <section class="section-bottom-66 section-xl-bottom-0" data-preset='{"title":"Carousel 2","category":"content, carousel","reload":true,"id":"carousel-2"}'>
        <div class="owl-carousel owl-carousel-default veil-lg-owl-dots veil-owl-nav reveal-lg-owl-nav" data-items="1" data-sm-items="2" data-lg-items="3" data-xl-items="4" data-nav="true" data-dots="true" data-nav-class="[&quot;owl-prev mdi mdi-chevron-left&quot;, &quot;owl-next mdi mdi-chevron-right&quot;]">
          <div>
            <!-- Thumbnail Terry-->
            <figure class="thumbnail-terry"><a href="#"><img width="480" height="480" src="images/01-480.png" alt=""/></a>
              <figcaption>
                <div>
          ...
          <div>
            <!-- Thumbnail Terry-->
            <figure class="thumbnail-terry"><a href="#"><img width="480" height="480" src="images/02-480.png" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title"></h4>
                </div>
          ...
          <div>
            <!-- Thumbnail Terry-->
            <figure class="thumbnail-terry"><a href="#"><img width="480" height="480" src="images/03-480.png" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title"></h4>
                </div>
          ...
          <div>
            <!-- Thumbnail Terry-->
            <figure class="thumbnail-terry"><a href="#"><img width="480" height="480" src="images/04-480.png" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title"></h4>
                </div>
          ...
          <div>
            <!-- Thumbnail Terry-->
            <figure class="thumbnail-terry"><a href="#"><img width="480" height="480" src="images/05-480.png" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title"></h4>
                </div>
          ...
          <div>
            <!-- Thumbnail Terry-->
            <figure class="thumbnail-terry"><a href="#"><img width="480" height="480" src="images/06-480.png" alt=""/></a>
              <figcaption>
                <div>
                  <h4 class="thumbnail-terry-title"></h4>
                </div>
              ...
              <div class="row justify-content-sm-center">
                ...
                <div class="col-sm-10 col-md-3 offset-top-66 order-md-1 offset-md-top-0 col-md-6 col-xl-3 order-xl-1">
                  ...
                  <p class="text-darker offset-top-20">GyMisha &copy; <span id="copyright-year"></span> .
                    Дизайн&nbsp;by&nbsp;<a href="https://www.templatemonster.com">Misha</a>
                  </p>
                </div>
              </div>
            </div>
